...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['_register_tg_webhook'])) {
        ...
        if (!$tgToken) {
            ...
            $resp = Helper::httpPost("https://api.telegram.org/bot{$tgToken}/setWebhook", [
                'url'             => currentSiteUrl() . '/telegram/callback',
                'allowed_updates' => json_encode(['message', 'callback_query', 'message_reaction']),
            ]);
