...
<div class="page-wrapper">
  ...
  <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;background:hsl(217 91% 60%/0.07);border:1px solid hsl(217 91% 60%/0.2);border-radius:var(--radius);margin-bottom:16px;font-size:12px;color:hsl(217 60% 40%);">
    <?= icon('send','',14) ?>
    <span>
      <strong>Telegram Bot:</strong> Operator CS bisa update status lead langsung via <strong>reaction</strong> pada pesan notifikasi —
      <strong>❤️ Love</strong> = Dihubungi &nbsp;·&nbsp;
      <strong>👍 Like</strong> = Beli &nbsp;·&nbsp;
      <strong>👎 Dislike</strong> = Batal.
      Pastikan webhook sudah didaftarkan ulang di <a href="../settings/index.php#telegram" style="color:hsl(217 91% 60%);font-weight:600;">Pengaturan → Telegram Bot</a>.
    </span>
  </div>
